...
namespace fmath {
	...
	inline float fast_log2(float x) { return fast_ln(x) * 1.442695f; }

	inline float fast_log10(float x) { return fast_ln(x) * 0.434294f; }
